...
String.prototype.upperFirst = function() { return this[0].toUpperCase() + this.substring(1); };
String.prototype.lowerFirst = function() { return this[0].toLowerCase() + this.substring(1); };
...
function mock(input) {
    ...
    output.push(`public class ${clazz.name}Test {\n\n`);
    output.push(`    private ${clazz.name} ${clazz.name.toLowerCase()};\n\n`);
